...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_60_iso_4th_row_all_1u(LT(2, KC_ESC), DK_1, DK_2, DK_3, DK_4, DK_5, DK_6, DK_7, DK_8, DK_9, DK_0, DK_PLUS, DK_ACUT, KC_BSPC, KC_TAB, DK_Q, DK_W, DK_E, DK_R, DK_T, DK_Y, DK_U, DK_I, DK_O, DK_P, DK_ARNG, DK_DIAE, TG(3), DK_A, DK_S, DK_D, DK_F, DK_G, DK_H, DK_J, DK_K, DK_L, DK_AE, DK_OSTR, DK_QUOT, KC_ENT, KC_LSFT, DK_LABK, DK_Z, DK_X, DK_C, DK_V, DK_B, DK_N, DK_M, DK_COMM, DK_DOT, KC_SLSH, KC_RSFT, KC_UP, MO(2), KC_LCTL, KC_LALT, KC_LGUI, KC_SPC, KC_RGUI, KC_RALT, KC_LEFT, KC_DOWN, KC_RGHT),

    [1] = LAYOUT_60_iso_4th_row_all_1u(LT(1, KC_ESC), DK_1, DK_2, DK_3, DK_4, DK_5, DK_6, DK_7, DK_8, DK_9, DK_0, DK_PLUS, DK_ACUT, KC_BSPC, KC_TAB, DK_Q, DK_W, DK_E, DK_R, DK_T, DK_Y, DK_U, DK_I, DK_O, DK_P, DK_ARNG, DK_DIAE, TG(3), DK_A, DK_S, DK_D, DK_F, DK_G, DK_H, DK_J, DK_K, DK_L, DK_AE, DK_OSTR, DK_QUOT, KC_ENT, KC_LSFT, DK_LABK, DK_Z, DK_X, DK_C, DK_V, DK_B, DK_N, DK_M, DK_COMM, DK_DOT, KC_SLSH, KC_RSFT, KC_UP, MO(1), KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, KC_RALT, KC_RGUI, KC_LEFT, KC_DOWN, KC_RGHT),
